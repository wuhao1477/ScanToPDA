...
class _BluetoothScannerPageState extends State<BluetoothScannerPage> with WidgetsBindingObserver {
  ...
  // 创建方法通道，用于控制后台服务
  static const MethodChannel _methodChannel = MethodChannel('com.example.bluetooth2pda/barcode_scanner');
  
  // 创建事件通道，用于接收扫码结果
  static const EventChannel _eventChannel = EventChannel('com.example.bluetooth2pda/barcode_scanner_events');
